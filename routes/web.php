...
Route::prefix('admin')->namespace('Admin')->group(function(){
    ...
    Route::prefix('market')->namespace('Market')->group(function(){
        ...
        Route::prefix('comment')->group(function(){
            ...
            Route::get('/answer/{comment}', [CommentController::class, 'answer'])->name('admin.market.comment.answer');
    ...
    Route::prefix('product')->group(function(){
        ...
        Route::get('/value/{categoryAttribute}/edit', [PropertyValueController::class, 'edit'])->name('admin.market.value.edit');
        Route::put('/value/{categoryAttribute}/update', [PropertyValueController::class, 'update'])->name('admin.market.value.update');
    ...
    Route::prefix('property')->group(function(){
      ...
      Route::prefix('store')->group(function(){
        ...
        Route::get('/edit/{store}', [StoreController::class, 'edit'])->name('admin.market.store.edit');
        Route::put('/update/{store}', [StoreController::class, 'update'])->name('admin.market.store.update');
        });
    });

                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach($posts as $key => $post)
                        <tr>
                            ...
                            <td>
                                <label>
                                    <input type="checkbox"  id="{{ $post->id }}" onchange="changeStatus({{ $post->id }})" @if($post->status === 1) checked @endif data-url="{{ route('admin.content.post.status', $post->id) }}">
                                </label>
                            </td>
                            <td>
                                <label>
                                    <input type="checkbox"  id="{{ $post->id }}-commentable" onchange="commentable({{ $post->id }})" @if($post->commentable === 1) checked @endif data-url="{{ route('admin.content.post.commentable', $post->id) }}">
                                </label>
                            </td>

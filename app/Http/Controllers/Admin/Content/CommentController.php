...
class CommentController extends Controller
{
    ...
    public function index()
    {
        ...
        $comments = Comment::where('commentable_type', Post::class)->orderBy('created_at', 'desc')->with('commentable')->simplePaginate(15);
    ...
    public function approved(Comment $comment)
    {
        ...
        if ($result) {
            return redirect()->route('admin.content.comment.index')->with('swal-success', 'تغییر وضعیت نظر با موفقیت انجام شد');
        } else {
